...
- `Tài khoản đề xuất` là tài khoản đang hoạt động bình thường, còn quota và phù hợp nhất để dùng tiếp. Ứng dụng ưu tiên quota còn lại cao hơn, sau đó ưu tiên thời điểm reset sớm hơn; ứng dụng không tự chuyển tài khoản.
- `Profile không còn dùng` là thư mục đăng nhập Codex cũ không còn khớp với tài khoản nào trong danh sách, thường xuất hiện sau khi xóa hoặc thay đổi tài khoản.
